...
OS_DISTRIBUTOR_CENTOS = "CentOS"
OS_DISTRIBUTOR_ROCKY = "Rocky"

# OS distribution RHEL6/CentOS6
DISTRO_RHEL6 = "rhel6"
# OS distribution RHEL7/CentOS7
DISTRO_RHEL7 = "rhel7"
# OS distribution RHEL8/CentOS8/Rocky9
DISTRO_RHEL8 = "rhel8"
# OS distribution RHEL8/CentOS9/Rocky9
DISTRO_RHEL9 = "rhel9"
...
def distro2short(log, distro):
    ...
    if distro == DISTRO_RHEL9:
        return DISTRO_SHORT_RHEL9
...
def short_distro2standard(log, short_distro):
    ...
    if short_distro == DISTRO_SHORT_RHEL8:
        return DISTRO_RHEL8
    if short_distro == DISTRO_SHORT_RHEL9:
        return DISTRO_RHEL9
...
def short_distro2type(log, short_distro):
    ...
    if short_distro in [DISTRO_SHORT_RHEL6, DISTRO_SHORT_RHEL7,
                        DISTRO_SHORT_RHEL8, DISTRO_SHORT_RHEL9]:
...
def distro2type(log, distro):
    """
    Return type from distro
    """
    short_distro = distro2short(log, distro)
    if short_distro is None:
        return None
    return short_distro2type(log, short_distro)
